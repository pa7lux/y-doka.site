...
{% demo "demos/basic", "Обычная ссылка", 120 %}
...
![Пример использования тега a с атрибутом и его значением](images/02-06-scheme-rus_1.png)
...
{% demo "demos/image", "Ссылка на изображении", 220 %}
...
{% demo "demos/mail", "Ссылка mailto", 120 %}
