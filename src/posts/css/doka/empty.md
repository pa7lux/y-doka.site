...
В примере выше, если есть результаты поиска, то блок с результатами будет отделяться от формы поиска отступом и
границей. Если результатов поиска нет, то блок с результатами отображаться не будет.
